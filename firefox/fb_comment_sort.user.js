...
function main() {   
	...
	$(document).ready(function(){	    
		...
		// "ADD SORT BUTTON" //
		/*
	    $('.pagesTimelineButtonPagelet').append('<span id="addSortButton" class="uiButtonGroup uiButtonGroupOverlay" style="margin-left:10px;"><span class="firstItem lastItem uiButtonGroupItem buttonItem"><span  class="uiButton uiButtonConfirm"><span class="uiButtonText">Add Sort Button</span></span></span></span>');
	    
	    $('#addSortButton').bind('click', function(){
		addSortButton();
	    });
	    */
